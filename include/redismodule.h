...
int REDISMODULE_API_FUNC(RedisModule_SaveLen)(void* rio, uint64_t value);
uint64_t REDISMODULE_API_FUNC(RedisModule_LoadLen)(void* rio);
void* REDISMODULE_API_FUNC(RedisModule_LoadModuleValue)( void* rio, RedisModuleType* type);
...
int REDISMODULE_API_FUNC(RedisModule_SetCrdtExpireRobj)(RedisModuleString *key, void* data);
int REDISMODULE_API_FUNC(RedisModule_SetCrdtExpireTombstoneRobj)(RedisModuleString *key, void* data);
