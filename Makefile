...
crdt.so: rmutil crdt.o crdt_register.o config.o ctrip_crdt_common.o
	$(LD) -o $@ crdt.o crdt_register.o config.o ctrip_crdt_common.o $(SHOBJ_LDFLAGS) $(LIBS) -L$(RMUTIL_LIBDIR) -lrmutil -lc
